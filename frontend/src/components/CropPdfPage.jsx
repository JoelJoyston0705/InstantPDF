...
import { Upload, Crop, CheckCircle, AlertCircle, Download, File, Scissors } from 'lucide-react';
import { Link } from 'react-router-dom';
import Confetti from './Confetti';

export default function CropPdfPage() {
    const [file, setFile] = useState(null);
    const [margin, setMargin] = useState(50); // Default 50px
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            // Send margin as query parameter
            const response = await fetch(`${API_URL}/edit/crop-pdf?t=${Date.now()}&margin=${margin}`, {
                method: 'POST',
                body: formData,
            });
            ...
            if (!response.ok) {
                ...
                throw new Error(errData.detail || 'Cropping failed');
            }
        ...
        <div className="min-h-screen pt-24 pb-16 px-6 page-transition">
            <div className="max-w-3xl mx-auto">
                ...
                <div className="text-center mb-16 animate-fade-in-up">
                    <div className="inline-flex items-center justify-center w-20 h-20 rounded-3xl bg-gradient-to-br from-amber-500 to-orange-500 shadow-2xl mb-8 text-white transform hover:scale-110 transition-transform">
                        <Crop size={40} strokeWidth={2} />
                    </div>
                    <h1 className="mb-4" style={{ letterSpacing: '-0.022em' }}>Crop PDF</h1>
                    <p className="subtitle max-w-xl mx-auto">
                        Trim whitespace margins from your PDF pages.
                    </p>
                </div>
                ...
                <div className="tool-card shadow-premium animate-scale-in max-w-2xl mx-auto">
                            ...
                            {!file ? (
                                ...
                                <div className="animate-fade-in">
                                    ...
                                    <div className="mb-8 max-w-sm mx-auto">
                                        <label className="block text-sm font-medium text-gray-700 mb-4">Crop Margin (Pixels)</label>
                                        <div className="flex flex-col gap-4">
                                            ...
                                            />
                                            <div className="text-center font-semibold text-amber-600">
                                                {margin}px margin
                                            </div>
                                        </div>
                                    </div>
                    ...
                    {status === 'converting' && (
                        <div className="p-20 text-center animate-fade-in">
                            ...
                            <p className="text-gray-500">Trimming your document.</p>
                        </div>
                    )}
